...
<div id="photos">
<?php if (has_capability("qc:edit{$type_str}specphotos")) : ?>
    <form method="post" action="qc/spec/upload_photos" enctype="multipart/form-data">
    <div>
...
<?php foreach ($photos as $photo) :
    $imgurl = "files/qc/$project_id/photos/small/$photo->hash";
?>
    <div class="specphoto">
            <h4>
                Photo #<?=$photonumber?>
            ...
            <p class="info">
                ...
                <a class="deletephoto" onclick="return deletethis();" href="/qc/spec/delete_photo/<?=$photo->id?>">delete</a>
            </p>
...
$(function() {
    ...
    $('.description').each(function (i) {
        ...
        $(this).editable('qc/spec/edit_photo_description/'+matches[1], {
            id: 'action',
            type: 'textarea',
            submit: 'Save',
            cancel: 'Cancel',
