...
<div <?= ! $add ? 'class="hidden"' : '' ?> style="width: 480px">
	...
	<? echo form_open('/estimates/material_type/process_add', array('id' => 'material_type_add_form')) ?>
		...
		<? print_form_container_open(); ?>
			...
			<? print_submit_container_open(); ?>
		    	<?= form_submit('submit', 'Add', 'data-url="estimates/material_type/process_add"'); ?>
...
<script>
	...
	var dataTableUrl = 'estimates/material_type/datatable';
</script>