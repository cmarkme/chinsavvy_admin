 ...
 */
	...
	} else if ($domain == 'chinasavvy-intranet') {
 ...
 */
	...
	else
	{
		...
		{
			exit("Your application folder (". BASEPATH.$application_folder. ") path does not appear to be set correctly. Please open the following file and correct this: ".SELF);
		}
