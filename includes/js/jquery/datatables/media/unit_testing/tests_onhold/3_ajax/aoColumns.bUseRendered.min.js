oTest.fnStart("aoColumns.bUseRendered");$(document).ready(function(){var mTmp=0;var oTable=$('#example').dataTable({"sAjaxSource":"../../../examples/ajax/sources/arrays.txt","aoColumns":[null,{"fnRender":function(a){if(mTmp==0){mTmp++;return"aaa";}else
